...
public class MyLeadsActivity extends BaseActivity {
    ...
    public void initiateButton(){
        if(type == constants.LEADS_ALL){
            checkPending();
        }
        else if(type == constants.LEADS_PENDING){
            checkPending();
        }

        else if(type == constants.LEADS_NOT_ANSWERED){
            checkPending();
        }

        else if(type == constants.LEADS_ANSWERED){
            automaticbutton.setText("Add More lead");
            automaticbutton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(MyLeadsActivity.this, AddLeadsActivity.class);
