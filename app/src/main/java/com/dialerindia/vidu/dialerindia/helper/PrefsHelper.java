...
public class PrefsHelper {
    ...
    public static void writePrefString(Context context, String key, String value) {
        new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPrefEditor().putString(key, value).commit();
    }

    public static String readPrefString(Context context, String key) {
        return new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPreference().getString(key, DEFAULT_STRING_VALUE);
    }

    //
    public static void writePrefInt(Context context, String key, int value) {
        new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPrefEditor().putInt(key, value).commit();
    }

    public static int readPrefInt(Context context, String key) {
        return new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPreference().getInt(key, DEFAULT_INT_VALUE);
    }
    //

    //
    public static void writePrefBool(Context context, String key, boolean value) {
        new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPrefEditor().putBoolean(key, value).commit();
    }

    public static boolean readPrefBool(Context context, String key) {
        return new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPreference().getBoolean(key, DEFAULT_BOOLEAN_VALUE);
    }
    //

    public static void clearPreference(Context context) {
        new com.dialerindia.vidu.dialerindia.callrecord.helper.PrefsHelper(context).getPreference().edit().clear().apply();
